...
public class Request {
    ...
    public static final String REQ_EPSILON_ANCHOR = "10";
    public static final String RES_EPSILON_ANCHOR = "11";
    public static final String REQ_WRIT_INIT = "12";
    public static final String REQ_SENSITIVITY_SET = "13";
    public static final String REQ_SET_WAVE_LEVEl = "14";
    public static final String REQ_PLAY_END_WAVE_SOUND = "15";
    public static final String REQ_ENDING_SCENE = "16";
    public static final String REQ_PLAY_CREATE_SOUND = "17";
    ...
    public static final String LEAGUE_REDIRECT = "43";
